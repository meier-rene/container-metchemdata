...
CMD echo $POSTGRES_IP:$POSTGRES_PORT:$POSTGRES_DB:$POSTGRES_USER:$POSTGRES_PASSWORD > ~/.pgpass && chmod 600 ~/.pgpass && bash /scripts/main.sh ; while true ; do date ; sleep 60 ; done 
